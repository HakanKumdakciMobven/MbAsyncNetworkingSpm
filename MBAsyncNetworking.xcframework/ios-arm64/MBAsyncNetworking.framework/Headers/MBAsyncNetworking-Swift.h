...
#ifndef MBASYNCNETWORKING_SWIFT_H
#define MBASYNCNETWORKING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MBAsyncNetworking",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17MBAsyncNetworking15StubURLProtocol")
...
@interface StubURLProtocol (SWIFT_EXTENSION(MBAsyncNetworking))
/// Determines if this protocol can handle the given request
/// \param request The URLRequest to check
///
///
/// returns:
...
/// \param task The URLSessionTask to check
///
///
/// returns:
/// true if stubbing is enabled, false otherwise
...
/// \param request The URLRequest to canonicalize
///
///
/// returns:
/// The same request (no modifications)
...
SWIFT_CLASS("_TtC17MBAsyncNetworking31URLSessionPinnableDelegateAsync")
@interface URLSessionPinnableDelegateAsync : NSObject
...
@interface URLSessionPinnableDelegateAsync (SWIFT_EXTENSION(MBAsyncNetworking)) <NSURLSessionTaskDelegate>
